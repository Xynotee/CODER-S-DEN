...
const techComp = "Google, Microsoft, Apple, IBM, Oracle, Amazon"
...
let randNumLess = math.ceil(randNum * 100)
console.log(randNumLess)
...
// 4 1 4 16 64
// 5 1 5 25 125
let series = parseInt('1 1 1 1 \n 2 1 2 4 8 \n 3 1 3 9 27')
console.log(series)
// Use substr to slice out the phrase because because because from the following sentence:'You cannot end a sentence with because because because is a conjunction'
let sent = 'You cannot end a sentence with because because because is a conjunction'
console.log(sent.substring('because').slice())
// Exercises: Level 3
// 'Love is the best thing in this world. Some found their love and some are still looking for their love.' Count the number of word love in this sentence.
let loveTalk = "'Love is the best thing in this world. Some found their love and some are still looking for their love.'"
console.log(loveTalk.match('love'))
